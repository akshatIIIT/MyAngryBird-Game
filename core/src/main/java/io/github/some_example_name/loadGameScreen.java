...
class loadGameScreen implements Screen {
    ...
    public loadGameScreen(game GAME,float WorldWidth,float WorldHeight){
        this.GAME=GAME;
        preferences=Gdx.app.getPreferences("database");
...
//            return false;
    ...
    public void Loading(){
        ...
        int i=1;
         Integer DATA=Integer.parseInt(rest.getPreferences().getString(String.valueOf(i), "-1"));
         System.out.println(DATA);
         while(DATA!=-1){
             for(int j=0;j<i;j++){
                 stage.getActors().get(j).setTouchable(Touchable.enabled);
             }
             i++;
             DATA=Integer.parseInt(rest.getPreferences().getString(String.valueOf(i),"-1"));
             System.out.println(DATA);
         }
         stage.getActors().get(i-1).setTouchable(Touchable.enabled);
//        rest.loading();
    }
...
//        if(LEVEL==1){
//            handlelevel=new LevelHandler("HIGH SCORE (4).png", stage.getWidth(), stage.getHeight(),GAME,LEVEL);
//            handlelevel.level1();
//        }
//        else if(LEVEL==2){
//            handlelevel=new LevelHandler("HIGH SCORE (3).png", stage.getWidth(), stage.getHeight(),GAME,LEVEL);
//            handlelevel.level2();
//        }
//        else if(LEVEL==3){
//            handlelevel=new LevelHandler("HIGH SCORE (5).png", stage.getWidth(), stage.getHeight(),GAME,LEVEL);
//            handlelevel.level3();
//        }
//        else{
