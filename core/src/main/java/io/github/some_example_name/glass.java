...
public class glass extends Species implements UPDATEINTERFACE{
    private int durability;
    private Sprite sprite;
    private SpriteBatch spritebatch;
    //public int health=100;
    public glass( World world,float WorldWidth,float WorldHeight,float x,float y,boolean orientation,float width,float height,String path){
        super(world, 30);
